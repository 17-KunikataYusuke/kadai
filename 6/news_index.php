   ...
   <article class="news-detail"> 
    ...
    <section class="news contents-box">
        ...
        <h2 class="section-title text-center">
            <span class="section-title__yellow">News</span><span class="section-title-ja text-center">日付</span>
        </h2>
...
foreach($results as $row) {
    ...
    $creDate=$row["create_date"];
    echo '<dt class="news-date">'.$creDate.'</dt>';
    echo '<dd class="news-description"><a href="news_detail.php?news_id='.$id.'">'
    .$title.'</a></dd>';
